...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x4038ae48, const void *arg_0x40389010);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x403da588) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x40523490), 
int (*key_eq_fn)(void *arg_0x405238a8, void *arg_0x40523a10));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40642bc4, int arg_0x40642d10);
static double RandomUniform(void );
...
typedef TMilli preambleTestC$Timer0$precision_tag;
typedef TMilli preambleTestC$routerTimer$precision_tag;
typedef TMilli preambleTestC$sleepTimer$precision_tag;
typedef TMilli preambleTestC$LocalTime$precision_tag;
typedef Message preambleTestC$SendQueue$t;
typedef TMilli preambleTestC$dataTimer$precision_tag;
typedef TMilli preambleTestC$waitforack$precision_tag;
...
typedef Message /*preambleTestAppC.SendQueueP*/QueueC$0$queue_t;
typedef /*preambleTestAppC.SendQueueP*/QueueC$0$queue_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$t;
...
static void preambleTestC$Timer0$fired(void );
#line 83
static void preambleTestC$routerTimer$fired(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void preambleTestC$AMControl$startDone(error_t error);
#line 138
static void preambleTestC$AMControl$stopDone(error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void preambleTestC$sleepTimer$fired(void );
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void preambleTestC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void preambleTestC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void preambleTestC$dataTimer$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void preambleTestC$waitforack$fired(void );
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
static 
#line 71
/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$t  

/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$head(void );
#line 90
static error_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$enqueue(
#line 86
/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$t  newVal);
#line 65
static uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$maxSize(void );
#line 81
static 
#line 79
/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$t  

/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$dequeue(void );
#line 50
static bool /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$empty(void );
...
static uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$size(void );
...
static void LedsP$Leds$led1Toggle(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void preambleTestC$Timer0$startOneShot(uint32_t dt);
#line 73
static void preambleTestC$routerTimer$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t preambleTestC$AMControl$start(void );
#line 130
static error_t preambleTestC$AMControl$stop(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void preambleTestC$sleepTimer$startOneShot(uint32_t dt);
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t preambleTestC$LocalTime$get(void );
...
preambleTestC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t preambleTestC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
static uint16_t preambleTestC$Random$rand16(void );
# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
static 
#line 71
preambleTestC$SendQueue$t  

preambleTestC$SendQueue$head(void );
#line 90
static error_t preambleTestC$SendQueue$enqueue(
#line 86
preambleTestC$SendQueue$t  newVal);
#line 81
static 
#line 79
preambleTestC$SendQueue$t  

preambleTestC$SendQueue$dequeue(void );
#line 50
static bool preambleTestC$SendQueue$empty(void );
...
static uint8_t preambleTestC$SendQueue$size(void );
# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void preambleTestC$Leds$led0Off(void );
#line 83
static void preambleTestC$Leds$led1Toggle(void );
#line 56
static void preambleTestC$Leds$led0On(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void preambleTestC$waitforack$startOneShot(uint32_t dt);




static void preambleTestC$waitforack$stop(void );
# 23 "preambleTestC.nc"
unsigned long preambleTestC$sleeptime[1000];
int preambleTestC$routetable[1000][15][2];
uint16_t preambleTestC$dest[1000];
uint16_t preambleTestC$counter1[1000];
uint16_t preambleTestC$counter[1000];
message_t preambleTestC$pkt[1000];
int preambleTestC$state[1000];
int preambleTestC$awakestate[1000];
int preambleTestC$sendtask[1000];
int preambleTestC$level[1000];
int preambleTestC$updateroute[1000];
bool preambleTestC$busy[1000];
int preambleTestC$sendflag[1000];
int preambleTestC$pstate[1000];
uint32_t preambleTestC$t1[1000];
uint32_t preambleTestC$t2[1000];
uint32_t preambleTestC$t3[1000][100];
int preambleTestC$isupdate[1000];
exprData preambleTestC$exp[1000];
int preambleTestC$countpre[1000];
int preambleTestC$flag1[1000];
static void preambleTestC$SendMessage(void );
static inline int preambleTestC$getetx(uint16_t nodeid);
static inline uint16_t preambleTestC$gettime(void );
static void preambleTestC$updateroutetable(void );
static void preambleTestC$inittemp(void );
static inline int preambleTestC$getdest(void );
static inline void preambleTestC$sort(void );
static int preambleTestC$getroutetablesize(void );
static inline int preambleTestC$getdest(void );
...
static inline void preambleTestC$Boot$booted(void );
#line 111
static void preambleTestC$updateroutetable(void );
#line 127
static inline void preambleTestC$AMControl$startDone(error_t err);
#line 155
static inline void preambleTestC$sleepTimer$fired(void );
#line 169
static inline void preambleTestC$Timer0$fired(void );
#line 182
static inline void preambleTestC$AMControl$stopDone(error_t err);
#line 198
static void preambleTestC$SendMessage(void );
#line 276
static inline void preambleTestC$routerTimer$fired(void );
...
static inline void preambleTestC$sort(void );
#line 303
static inline void preambleTestC$dataTimer$fired(void );




static inline void preambleTestC$waitforack$fired(void );
...
static void preambleTestC$AMSend$sendDone(message_t *msg, error_t err);
#line 363
static inline message_t *preambleTestC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 53 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
/*preambleTestAppC.SendQueueP*/QueueC$0$queue_t  /*preambleTestAppC.SendQueueP*/QueueC$0$queue[1000][20];
uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$head[1000];
uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$tail[1000];
uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$size[1000];

static inline bool /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$empty(void );



static inline uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$size(void );



static inline uint8_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$maxSize(void );



static inline /*preambleTestAppC.SendQueueP*/QueueC$0$queue_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$head(void );



static void /*preambleTestAppC.SendQueueP*/QueueC$0$printQueue(void );
#line 85
static inline /*preambleTestAppC.SendQueueP*/QueueC$0$queue_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$dequeue(void );
#line 97
static inline error_t /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$enqueue(/*preambleTestAppC.SendQueueP*/QueueC$0$queue_t newVal);
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void preambleTestC$routerTimer$startOneShot(uint32_t dt){
#line 73
...
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t preambleTestC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 57
{
  return /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()];
}

# 58 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static uint8_t preambleTestC$SendQueue$size(void ){
#line 58
  unsigned char __nesc_result;
#line 58

#line 58
  __nesc_result = /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$size();
#line 58
...
#line 65
{
  return /*preambleTestAppC.SendQueueP*/QueueC$0$queue[sim_node()][/*preambleTestAppC.SendQueueP*/QueueC$0$head[sim_node()]];
}

# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static preambleTestC$SendQueue$t  preambleTestC$SendQueue$head(void ){
#line 73
  nx_struct Message __nesc_result;
#line 73

#line 73
  __nesc_result = /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$head();
#line 73
...
#line 97
{
  if (/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$size() < /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$maxSize()) {
      sim_log_debug(204U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()]);
      /*preambleTestAppC.SendQueueP*/QueueC$0$queue[sim_node()][/*preambleTestAppC.SendQueueP*/QueueC$0$tail[sim_node()]] = newVal;
      /*preambleTestAppC.SendQueueP*/QueueC$0$tail[sim_node()]++;
      if (/*preambleTestAppC.SendQueueP*/QueueC$0$tail[sim_node()] == 20) {
#line 102
        /*preambleTestAppC.SendQueueP*/QueueC$0$tail[sim_node()] = 0;
        }
#line 103
      /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()]++;
      /*preambleTestAppC.SendQueueP*/QueueC$0$printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
inline static error_t preambleTestC$SendQueue$enqueue(preambleTestC$SendQueue$t  newVal){
#line 90
  unsigned char __nesc_result;
#line 90

#line 90
  __nesc_result = /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$enqueue(newVal);
#line 90
...
# 61 "/opt/tinyos-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t preambleTestC$LocalTime$get(void ){
#line 61
  unsigned int __nesc_result;
#line 61
...
#line 52
{
  return preambleTestC$routetable[sim_node()][0][0];
}
...
#line 288
  for (i = 0; i < 15; i++) 
    for (j = i + 1; j < 15; j++) 
      {
        if (preambleTestC$routetable[sim_node()][i][1] > preambleTestC$routetable[sim_node()][j][1] && preambleTestC$routetable[sim_node()][i][1] > 0 && preambleTestC$routetable[sim_node()][j][1] > 0) 
          {
            int temp = preambleTestC$routetable[sim_node()][i][1];

#line 294
            preambleTestC$routetable[sim_node()][i][1] = preambleTestC$routetable[sim_node()][j][1];
            preambleTestC$routetable[sim_node()][j][1] = temp;
            temp = preambleTestC$routetable[sim_node()][i][0];
            preambleTestC$routetable[sim_node()][i][0] = preambleTestC$routetable[sim_node()][j][0];
            preambleTestC$routetable[sim_node()][j][0] = temp;
          }
      }
}
...
inline static void preambleTestC$waitforack$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(2U);
#line 78
}
#line 78
# 363 "preambleTestC.nc"
static inline message_t *preambleTestC$Receive$receive(message_t *msg, void *payload, uint8_t len)
#line 363
{
  ...
  if (len == sizeof(Message )) 
    {
      ...
      if (__nesc_ntoh_uint16(btrpkt->datatype.nxdata) == 4) {
          int i;

#line 370
          preambleTestC$t2[sim_node()] = preambleTestC$LocalTime$get();
          sim_log_debug(160U, "senddelay", "receive 4\n");
          for (i = 0; i < 100; i++) {
              if (preambleTestC$t3[sim_node()][i] == 0) {
                  sim_log_debug(161U, "count", "%d   %d   %d    %d\n", preambleTestC$t2[sim_node()], preambleTestC$t1[sim_node()], preambleTestC$counter[sim_node()], preambleTestC$counter1[sim_node()]);
                  preambleTestC$t3[sim_node()][i] = preambleTestC$t2[sim_node()] - preambleTestC$t1[sim_node()];
                  break;
                }
            }

          sim_log_debug(162U, "senddelay", "receive 4 .\n");
        }
      if (__nesc_ntoh_uint16(btrpkt->datatype.nxdata) == 1) {

          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 384
            {
              if (__nesc_ntoh_uint16(btrpkt->level.nxdata) > preambleTestC$level[sim_node()]) {
                  preambleTestC$sendflag[sim_node()] = 2;
                  preambleTestC$dest[sim_node()] = __nesc_ntoh_uint16(btrpkt->nodeid.nxdata);
                  preambleTestC$SendMessage();
                }
            }
#line 390
            __nesc_atomic_end(__nesc_atomic); }
        }
      if (__nesc_ntoh_uint16(btrpkt->datatype.nxdata) == 2) {
          if (TOS_NODE_ID == 0) {
            }
          else 
            {
...
#line 398
                {
                  if (__nesc_ntoh_uint16(btrpkt->level.nxdata) < preambleTestC$level[sim_node()]) {
                      preambleTestC$countpre[sim_node()]++;
                      for (i = 0; i < 15; i++) 
                        {
                          if (preambleTestC$routetable[sim_node()][i][0] == -1) 
                            {
                              preambleTestC$routetable[sim_node()][i][0] = __nesc_ntoh_uint16(btrpkt->nodeid.nxdata);
                              s = preambleTestC$Random$rand16() % 29 + 50;
                              preambleTestC$routetable[sim_node()][i][1] = __nesc_ntoh_uint16(btrpkt->etx.nxdata);
                              break;
                            }
                        }
                    }
                  if (preambleTestC$countpre[sim_node()] >= 0.8 * preambleTestC$getroutetablesize() && preambleTestC$countpre[sim_node()] >= 1) {
                      preambleTestC$waitforack$stop();
                      preambleTestC$sort();
                      preambleTestC$dest[sim_node()] = preambleTestC$getdest();
                      sim_log_debug(163U, "ack", "send data to %d\n", preambleTestC$getdest());
                      if (preambleTestC$flag1[sim_node()] == 1) {
                          preambleTestC$flag1[sim_node()] = 0;
                          preambleTestC$sendflag[sim_node()] = 3;
                          preambleTestC$SendMessage();
                        }
                    }
                }
#line 423
      ...
      if (__nesc_ntoh_uint16(btrpkt->datatype.nxdata) == 3) {
          if (TOS_NODE_ID == 0) 
            {
              int tend;

#line 432
              tend = preambleTestC$LocalTime$get();
              sim_log_debug(164U, "endtoend", "%d %d %d %d \n", __nesc_ntoh_uint16(btrpkt->nodeid.nxdata), __nesc_ntoh_uint16(btrpkt->data2.nxdata), tend, __nesc_ntoh_uint32(btrpkt->data1.nxdata));
            }
          else {
              Message temp;

#line 437
              __nesc_hton_uint16(temp.nodeid.nxdata, __nesc_ntoh_uint16(btrpkt->nodeid.nxdata));
              __nesc_hton_uint16(temp.dest.nxdata, __nesc_ntoh_uint16(btrpkt->dest.nxdata));
              __nesc_hton_uint16(temp.datatype.nxdata, __nesc_ntoh_uint16(btrpkt->datatype.nxdata));
              __nesc_hton_uint16(temp.level.nxdata, __nesc_ntoh_uint16(btrpkt->level.nxdata));
              __nesc_hton_uint32(temp.data1.nxdata, __nesc_ntoh_uint32(btrpkt->data1.nxdata));
              __nesc_hton_uint16(temp.data2.nxdata, __nesc_ntoh_uint16(btrpkt->data2.nxdata) + 1);
              __nesc_hton_uint8(temp.remain.nxdata, __nesc_ntoh_uint8(btrpkt->remain.nxdata));
              __nesc_hton_uint16(temp.etx.nxdata, __nesc_ntoh_uint16(btrpkt->etx.nxdata));
              __nesc_hton_uint16(temp.time.nxdata, __nesc_ntoh_uint16(btrpkt->time.nxdata));
              if (preambleTestC$SendQueue$enqueue(temp) == SUCCESS) {
                  Message testpkt = preambleTestC$SendQueue$head();

#line 448
                  sim_log_debug(165U, "tran", "store %d data  %d    %d \n", __nesc_ntoh_uint16(testpkt.nodeid.nxdata), __nesc_ntoh_uint16(testpkt.dest.nxdata), preambleTestC$SendQueue$size());
                }
            }
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 451
            {
              preambleTestC$sendflag[sim_node()] = 4;
              preambleTestC$dest[sim_node()] = __nesc_ntoh_uint16(btrpkt->dest.nxdata);
              preambleTestC$SendMessage();
            }
#line 455
            __nesc_atomic_end(__nesc_atomic); }
        }
      if (__nesc_ntoh_uint16(btrpkt->datatype.nxdata) == 5) {
          if (TOS_NODE_ID != 0) {
              int r;

#line 460
              if (__nesc_ntoh_uint16(btrpkt->level.nxdata) <= preambleTestC$level[sim_node()]) {
                  if (preambleTestC$level[sim_node()] == 65535) {
                    preambleTestC$level[sim_node()] = __nesc_ntoh_uint16(btrpkt->level.nxdata) + 1;
                    }
#line 463
                  r = preambleTestC$Random$rand16() / 65;
                  preambleTestC$routerTimer$startOneShot(9000 + r);
                }
            }
        }
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40892604, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40892604) {
#line 78
    case 6:
#line 78
      __nesc_result = preambleTestC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40892604, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * preambleTestC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 70
{
  return preambleTestC$getroutetablesize();
}
...
#line 53
{
  return /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()] == 0;
}

# 50 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static bool preambleTestC$SendQueue$empty(void ){
#line 50
  unsigned char __nesc_result;
#line 50

#line 50
  __nesc_result = /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$empty();
#line 50
...
#line 50
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t preambleTestC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
# 170 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMPacket$setType(message_t *amsg, am_id_t t)
#line 170
{
  tossim_header_t *header = TossimActiveMessageC$getHeader(amsg);
...
inline static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40be1cac, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40be1cac, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x4088bc7c, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x4088bc7c, msg, error);
#line 110
}
#line 110
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void preambleTestC$waitforack$startOneShot(uint32_t dt){
#line 73
...
#line 85
{
  /*preambleTestAppC.SendQueueP*/QueueC$0$queue_t t = /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$head();

#line 87
  sim_log_debug(203U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()]);
  if (!/*preambleTestAppC.SendQueueP*/QueueC$0$Queue$empty()) {
      /*preambleTestAppC.SendQueueP*/QueueC$0$head[sim_node()]++;
      if (/*preambleTestAppC.SendQueueP*/QueueC$0$head[sim_node()] == 20) {
#line 90
        /*preambleTestAppC.SendQueueP*/QueueC$0$head[sim_node()] = 0;
        }
#line 91
      /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()]--;
      /*preambleTestAppC.SendQueueP*/QueueC$0$printQueue();
...
inline static preambleTestC$SendQueue$t  preambleTestC$SendQueue$dequeue(void ){
#line 81
  nx_struct Message __nesc_result;
#line 81

#line 81
  __nesc_result = /*preambleTestAppC.SendQueueP*/QueueC$0$Queue$dequeue();
#line 81
...
inline static void preambleTestC$Leds$led1Toggle(void ){
#line 83
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x40892c5c, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x40892c5c, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t preambleTestC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void preambleTestC$Timer0$startOneShot(uint32_t dt){
#line 73
...
inline static void preambleTestC$Leds$led0On(void ){
#line 56
  LedsP$Leds$led0On();
#line 56
}
#line 56
# 127 "preambleTestC.nc"
static inline void preambleTestC$AMControl$startDone(error_t err)
#line 127
{
  if (err == SUCCESS) 
    {
      preambleTestC$counter[sim_node()]++;
      preambleTestC$t1[sim_node()] = 0;
      preambleTestC$t2[sim_node()] = 0;
      preambleTestC$awakestate[sim_node()] = 1;
      preambleTestC$Leds$led0On();
      if (preambleTestC$updateroute[sim_node()] == 1) {
          if (TOS_NODE_ID == 0) {
              preambleTestC$level[sim_node()] = 0;
              preambleTestC$updateroutetable();
            }
        }
      if (preambleTestC$updateroute[sim_node()] == 0 && TOS_NODE_ID != 0) {



          preambleTestC$pstate[sim_node()] = 0;
          preambleTestC$state[sim_node()] = 0;
          preambleTestC$Timer0$startOneShot(5000);
        }
    }
  else {
      preambleTestC$AMControl$start();
    }
}
...
#line 113
  preambleTestC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
inline static error_t preambleTestC$AMControl$stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130
...
{
  LedsP$Led0$set();
  sim_log_debug(150U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 81
  ;
}

# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void preambleTestC$Leds$led0Off(void ){
#line 61
  LedsP$Leds$led0Off();
#line 61
}
#line 61
# 182 "preambleTestC.nc"
static inline void preambleTestC$AMControl$stopDone(error_t err)
{
  if (err == SUCCESS) 
    {
      preambleTestC$Leds$led0Off();
      preambleTestC$state[sim_node()] = 0;
      preambleTestC$pstate[sim_node()] = 0;
      preambleTestC$awakestate[sim_node()] = 0;
      preambleTestC$sleepTimer$startOneShot(preambleTestC$sleeptime[sim_node()]);
    }
  else 
    {
      preambleTestC$AMControl$stop();
    }
}
...
#line 138
  preambleTestC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  preambleTestC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40be1310, message_t * msg, error_t error){
#line 100
  switch (arg_0x40be1310) {
#line 100
    case 0U:
#line 100
      /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40be1310, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40422b9c){
#line 75
  switch (arg_0x40422b9c) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40422b9c);
#line 75
      break;
#line 75
    }
...
#line 75
# 169 "preambleTestC.nc"
static inline void preambleTestC$Timer0$fired(void )
#line 169
{

  preambleTestC$sendtask[sim_node()] = 1;
  if (preambleTestC$awakestate[sim_node()] == 1 && preambleTestC$sendtask[sim_node()] == 1) 
    {
      preambleTestC$state[sim_node()] = 1;

      preambleTestC$sendflag[sim_node()] = 1;
      if (TOS_NODE_ID != 0) {
        preambleTestC$SendMessage();
        }
    }
...
#line 155
{
  preambleTestC$updateroute[sim_node()] = 0;
  if (preambleTestC$awakestate[sim_node()] == 1) 
    {
      preambleTestC$AMControl$stop();
    }

  if (preambleTestC$awakestate[sim_node()] == 0) 
    {
      preambleTestC$AMControl$start();
    }
}
...
static inline void preambleTestC$routerTimer$fired(void )
{
  if (preambleTestC$isupdate[sim_node()] == 0) 
    {
      preambleTestC$isupdate[sim_node()] = 1;
      preambleTestC$updateroutetable();
    }
#line 282
  preambleTestC$AMControl$stop();
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b7ccf8){
#line 83
  switch (arg_0x40b7ccf8) {
#line 83
    case 0U:
#line 83
      preambleTestC$Timer0$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      preambleTestC$sleepTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      preambleTestC$waitforack$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      preambleTestC$routerTimer$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      preambleTestC$dataTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b7ccf8);
#line 83
      break;
#line 83
    }
...
#line 90
  preambleTestC$flag1[sim_node()] = 1;
  if (TOS_NODE_ID < 20) {
    preambleTestC$sleeptime[sim_node()] = 20000;
    }
  else {
#line 93
    if (TOS_NODE_ID < 30) {
      preambleTestC$sleeptime[sim_node()] = 12500;
      }
    else {
#line 96
      preambleTestC$sleeptime[sim_node()] = 100000;
      }
    }
#line 97
  for (i = 0; i < 100; i++) 
    preambleTestC$t3[sim_node()][i] = 0;
  preambleTestC$level[sim_node()] = 65535;
  preambleTestC$countpre[sim_node()] = 0;
  preambleTestC$counter[sim_node()] = 0;
  preambleTestC$counter1[sim_node()] = 0;
  preambleTestC$sendtask[sim_node()] = 0;
  preambleTestC$updateroute[sim_node()] = 1;
  preambleTestC$isupdate[sim_node()] = 0;
  preambleTestC$sendflag[sim_node()] = 0;
  preambleTestC$inittemp();
  preambleTestC$AMControl$start();
}
...
# 198 "preambleTestC.nc"
static void preambleTestC$SendMessage(void )
#line 198
{
  Message *btrpkt = (Message *)preambleTestC$Packet$getPayload(&preambleTestC$pkt[sim_node()], sizeof(Message ));

#line 200
  if (preambleTestC$sendflag[sim_node()] == 1) {
      __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->dest.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->datatype.nxdata, 1);
      __nesc_hton_uint16(btrpkt->level.nxdata, preambleTestC$level[sim_node()]);
      __nesc_hton_uint32(btrpkt->data1.nxdata, 0);
      __nesc_hton_uint16(btrpkt->data2.nxdata, 0);
      __nesc_hton_uint8(btrpkt->remain.nxdata, 0);
      __nesc_hton_uint16(btrpkt->etx.nxdata, preambleTestC$getetx(TOS_NODE_ID));
      __nesc_hton_uint16(btrpkt->time.nxdata, preambleTestC$gettime());
    }
  if (preambleTestC$sendflag[sim_node()] == 2) {
      __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->dest.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->datatype.nxdata, 2);
      __nesc_hton_uint16(btrpkt->level.nxdata, preambleTestC$level[sim_node()]);
      __nesc_hton_uint32(btrpkt->data1.nxdata, 0);
      __nesc_hton_uint16(btrpkt->data2.nxdata, 0);
      __nesc_hton_uint8(btrpkt->remain.nxdata, 0);
  ...
  if (preambleTestC$sendflag[sim_node()] == 3) {
      if (!preambleTestC$SendQueue$empty()) {
          Message msgpkt = preambleTestC$SendQueue$head();

#line 225
          __nesc_hton_uint16(btrpkt->nodeid.nxdata, __nesc_ntoh_uint16(msgpkt.nodeid.nxdata));
          __nesc_hton_uint16(btrpkt->dest.nxdata, TOS_NODE_ID);
          __nesc_hton_uint16(btrpkt->datatype.nxdata, __nesc_ntoh_uint16(msgpkt.datatype.nxdata));
          __nesc_hton_uint16(btrpkt->level.nxdata, __nesc_ntoh_uint16(msgpkt.level.nxdata));
          __nesc_hton_uint32(btrpkt->data1.nxdata, __nesc_ntoh_uint32(msgpkt.data1.nxdata));
          __nesc_hton_uint16(btrpkt->data2.nxdata, __nesc_ntoh_uint16(msgpkt.data2.nxdata));
          __nesc_hton_uint8(btrpkt->remain.nxdata, __nesc_ntoh_uint8(msgpkt.remain.nxdata));
          __nesc_hton_uint16(btrpkt->etx.nxdata, preambleTestC$getetx(TOS_NODE_ID));
          __nesc_hton_uint16(btrpkt->time.nxdata, preambleTestC$gettime());
        }
      else {
#line 235
        if (preambleTestC$sendtask[sim_node()] == 1) {
            preambleTestC$sendtask[sim_node()] = 0;
            __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
            __nesc_hton_uint16(btrpkt->dest.nxdata, TOS_NODE_ID);
            __nesc_hton_uint16(btrpkt->datatype.nxdata, 3);
            __nesc_hton_uint16(btrpkt->level.nxdata, preambleTestC$level[sim_node()]);
            __nesc_hton_uint32(btrpkt->data1.nxdata, preambleTestC$t1[sim_node()]);
            __nesc_hton_uint16(btrpkt->data2.nxdata, 0);
            __nesc_hton_uint8(btrpkt->remain.nxdata, 0);
            __nesc_hton_uint16(btrpkt->etx.nxdata, preambleTestC$getetx(TOS_NODE_ID));
            __nesc_hton_uint16(btrpkt->time.nxdata, preambleTestC$gettime());
...
#line 248
  if (preambleTestC$sendflag[sim_node()] == 4) {
      __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->dest.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->datatype.nxdata, 4);
      __nesc_hton_uint16(btrpkt->level.nxdata, preambleTestC$level[sim_node()]);
      __nesc_hton_uint32(btrpkt->data1.nxdata, 0);
      __nesc_hton_uint16(btrpkt->data2.nxdata, 0);
      __nesc_hton_uint8(btrpkt->remain.nxdata, 0);
  ...
  if (!preambleTestC$busy[sim_node()]) {
      preambleTestC$busy[sim_node()] = TRUE;
      if (preambleTestC$sendflag[sim_node()] == 1) {
        preambleTestC$dest[sim_node()] = 0xffff;
        }
#line 263
      if (preambleTestC$AMSend$send(preambleTestC$dest[sim_node()], &preambleTestC$pkt[sim_node()], sizeof(Message )) == SUCCESS) 
        {
          if (__nesc_ntoh_uint16(btrpkt->nodeid.nxdata) != __nesc_ntoh_uint16(btrpkt->dest.nxdata)) {
            preambleTestC$Leds$led1Toggle();
            }
        }
      else 
#line 267
        {
          sim_log_debug(158U, "ack", "send error/n");
        }
    }
  else {
      sim_log_debug(159U, "ack", "busy error\n");
    }
}
...
#line 55
{
  /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*preambleTestAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
# 316 "preambleTestC.nc"
static void preambleTestC$AMSend$sendDone(message_t *msg, error_t err)
#line 316
{
  preambleTestC$busy[sim_node()] = FALSE;
  if (&preambleTestC$pkt[sim_node()] == msg) {
      if (preambleTestC$sendflag[sim_node()] == 1) {
          preambleTestC$counter1[sim_node()]++;
          if (preambleTestC$t1[sim_node()] == 0) {
              preambleTestC$t1[sim_node()] = preambleTestC$LocalTime$get();
            }
          preambleTestC$waitforack$startOneShot(500);
        }
      if (preambleTestC$sendflag[sim_node()] == 2) 
        {
        }
      if (preambleTestC$sendflag[sim_node()] == 3) 
        {
          ...
          preambleTestC$pstate[sim_node()] = 0;
          if (!preambleTestC$SendQueue$empty()) {
            preambleTestC$SendQueue$dequeue();
            }
#line 338
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 338
            {
              if (preambleTestC$SendQueue$empty()) {
                  if (preambleTestC$state[sim_node()] == 1) {
                    preambleTestC$sleepTimer$startOneShot(5000);
                    }
                }
              else 
#line 343
...
#line 58
  preambleTestC$exp[sim_node()].countPre = 0;
  preambleTestC$exp[sim_node()].countPreAck = 0;
  preambleTestC$exp[sim_node()].countData = 0;
  preambleTestC$exp[sim_node()].countDataAck = 0;
  preambleTestC$exp[sim_node()].TimePoint1 = 0;
  preambleTestC$exp[sim_node()].TimePoint2 = 0;
  preambleTestC$exp[sim_node()].TimePoint3 = 0;
  preambleTestC$exp[sim_node()].TimePoint4 = 0;
  for (i; i < 15; i++) {
      preambleTestC$routetable[sim_node()][i][0] = -1;
      preambleTestC$routetable[sim_node()][i][1] = -1;
    }
}
...
#line 72
  sim_log_debug(198U, "QueueC", "head <-");
  for (i = /*preambleTestAppC.SendQueueP*/QueueC$0$head[sim_node()]; i < /*preambleTestAppC.SendQueueP*/QueueC$0$head[sim_node()] + /*preambleTestAppC.SendQueueP*/QueueC$0$size[sim_node()]; i++) {
      sim_log_debug_clear(199U, "QueueC", "[");
      for (j = 0; j < sizeof(/*preambleTestAppC.SendQueueP*/QueueC$0$queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*preambleTestAppC.SendQueueP*/QueueC$0$queue[sim_node()][i % 20])[j];

#line 77
          sim_log_debug_clear(200U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(201U, "QueueC", "] ");
    }
  sim_log_debug_clear(202U, "QueueC", "<- tail\n");
}
...
{
  LedsP$Led1$toggle();
  sim_log_debug(154U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 101
  ;
}
...
# 111 "preambleTestC.nc"
static void preambleTestC$updateroutetable(void )
#line 111
{
  Message *msgpkt = (Message *)preambleTestC$Packet$getPayload(&preambleTestC$pkt[sim_node()], sizeof(Message ));

#line 113
  __nesc_hton_uint16(msgpkt->nodeid.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(msgpkt->datatype.nxdata, 5);
  __nesc_hton_uint16(msgpkt->level.nxdata, preambleTestC$level[sim_node()]);
  __nesc_hton_uint32(msgpkt->data1.nxdata, 0);
  __nesc_hton_uint16(msgpkt->data2.nxdata, 0);
  __nesc_hton_uint8(msgpkt->remain.nxdata, 0);
  __nesc_hton_uint16(msgpkt->etx.nxdata, preambleTestC$getetx(TOS_NODE_ID));
  __nesc_hton_uint16(msgpkt->time.nxdata, preambleTestC$gettime());
  if (preambleTestC$AMSend$send(0xffff, &preambleTestC$pkt[sim_node()], sizeof(Message )) == SUCCESS) 
    {
      preambleTestC$Leds$led1Toggle();
    }
}

# 115 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static error_t TossimPacketModelC$Control$stop(void )
#line 115
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "preambleTestC$sleeptime"))
  {
    *addr = (uintptr_t)&preambleTestC$sleeptime[__nesc_mote];
    *size = sizeof(preambleTestC$sleeptime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$routetable"))
  {
    *addr = (uintptr_t)&preambleTestC$routetable[__nesc_mote];
    *size = sizeof(preambleTestC$routetable[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$dest"))
  {
    *addr = (uintptr_t)&preambleTestC$dest[__nesc_mote];
    *size = sizeof(preambleTestC$dest[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$counter1"))
  {
    *addr = (uintptr_t)&preambleTestC$counter1[__nesc_mote];
    *size = sizeof(preambleTestC$counter1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$counter"))
  {
    *addr = (uintptr_t)&preambleTestC$counter[__nesc_mote];
    *size = sizeof(preambleTestC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$pkt"))
  {
    *addr = (uintptr_t)&preambleTestC$pkt[__nesc_mote];
    *size = sizeof(preambleTestC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$state"))
  {
    *addr = (uintptr_t)&preambleTestC$state[__nesc_mote];
    *size = sizeof(preambleTestC$state[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$awakestate"))
  {
    *addr = (uintptr_t)&preambleTestC$awakestate[__nesc_mote];
    *size = sizeof(preambleTestC$awakestate[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$sendtask"))
  {
    *addr = (uintptr_t)&preambleTestC$sendtask[__nesc_mote];
    *size = sizeof(preambleTestC$sendtask[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$level"))
  {
    *addr = (uintptr_t)&preambleTestC$level[__nesc_mote];
    *size = sizeof(preambleTestC$level[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$updateroute"))
  {
    *addr = (uintptr_t)&preambleTestC$updateroute[__nesc_mote];
    *size = sizeof(preambleTestC$updateroute[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$busy"))
  {
    *addr = (uintptr_t)&preambleTestC$busy[__nesc_mote];
    *size = sizeof(preambleTestC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$sendflag"))
  {
    *addr = (uintptr_t)&preambleTestC$sendflag[__nesc_mote];
    *size = sizeof(preambleTestC$sendflag[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$pstate"))
  {
    *addr = (uintptr_t)&preambleTestC$pstate[__nesc_mote];
    *size = sizeof(preambleTestC$pstate[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$t1"))
  {
    *addr = (uintptr_t)&preambleTestC$t1[__nesc_mote];
    *size = sizeof(preambleTestC$t1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$t2"))
  {
    *addr = (uintptr_t)&preambleTestC$t2[__nesc_mote];
    *size = sizeof(preambleTestC$t2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$t3"))
  {
    *addr = (uintptr_t)&preambleTestC$t3[__nesc_mote];
    *size = sizeof(preambleTestC$t3[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$isupdate"))
  {
    *addr = (uintptr_t)&preambleTestC$isupdate[__nesc_mote];
    *size = sizeof(preambleTestC$isupdate[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$exp"))
  {
    *addr = (uintptr_t)&preambleTestC$exp[__nesc_mote];
    *size = sizeof(preambleTestC$exp[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$countpre"))
  {
    *addr = (uintptr_t)&preambleTestC$countpre[__nesc_mote];
    *size = sizeof(preambleTestC$countpre[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "preambleTestC$flag1"))
  {
    *addr = (uintptr_t)&preambleTestC$flag1[__nesc_mote];
    *size = sizeof(preambleTestC$flag1[__nesc_mote]);
    return 0;
  }
  ...
  /* Module QueueC$0 */
  if (!strcmp(varname, "/*preambleTestAppC.SendQueueP*/QueueC$0$queue"))
  {
    *addr = (uintptr_t)&/*preambleTestAppC.SendQueueP*/QueueC$0$queue[__nesc_mote];
    *size = sizeof(/*preambleTestAppC.SendQueueP*/QueueC$0$queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*preambleTestAppC.SendQueueP*/QueueC$0$head"))
  {
    *addr = (uintptr_t)&/*preambleTestAppC.SendQueueP*/QueueC$0$head[__nesc_mote];
    *size = sizeof(/*preambleTestAppC.SendQueueP*/QueueC$0$head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*preambleTestAppC.SendQueueP*/QueueC$0$tail"))
  {
    *addr = (uintptr_t)&/*preambleTestAppC.SendQueueP*/QueueC$0$tail[__nesc_mote];
    *size = sizeof(/*preambleTestAppC.SendQueueP*/QueueC$0$tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*preambleTestAppC.SendQueueP*/QueueC$0$size"))
  {
    *addr = (uintptr_t)&/*preambleTestAppC.SendQueueP*/QueueC$0$size[__nesc_mote];
    *size = sizeof(/*preambleTestAppC.SendQueueP*/QueueC$0$size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module preambleTestC */
  memset((void *)&preambleTestC$sleeptime[__nesc_mote], 0, sizeof preambleTestC$sleeptime[__nesc_mote]);
  memset((void *)&preambleTestC$routetable[__nesc_mote], 0, sizeof preambleTestC$routetable[__nesc_mote]);
  memset((void *)&preambleTestC$dest[__nesc_mote], 0, sizeof preambleTestC$dest[__nesc_mote]);
  memset((void *)&preambleTestC$counter1[__nesc_mote], 0, sizeof preambleTestC$counter1[__nesc_mote]);
  memset((void *)&preambleTestC$counter[__nesc_mote], 0, sizeof preambleTestC$counter[__nesc_mote]);
  memset((void *)&preambleTestC$pkt[__nesc_mote], 0, sizeof preambleTestC$pkt[__nesc_mote]);
  memset((void *)&preambleTestC$state[__nesc_mote], 0, sizeof preambleTestC$state[__nesc_mote]);
  memset((void *)&preambleTestC$awakestate[__nesc_mote], 0, sizeof preambleTestC$awakestate[__nesc_mote]);
  memset((void *)&preambleTestC$sendtask[__nesc_mote], 0, sizeof preambleTestC$sendtask[__nesc_mote]);
  memset((void *)&preambleTestC$level[__nesc_mote], 0, sizeof preambleTestC$level[__nesc_mote]);
  memset((void *)&preambleTestC$updateroute[__nesc_mote], 0, sizeof preambleTestC$updateroute[__nesc_mote]);
  memset((void *)&preambleTestC$busy[__nesc_mote], 0, sizeof preambleTestC$busy[__nesc_mote]);
  memset((void *)&preambleTestC$sendflag[__nesc_mote], 0, sizeof preambleTestC$sendflag[__nesc_mote]);
  memset((void *)&preambleTestC$pstate[__nesc_mote], 0, sizeof preambleTestC$pstate[__nesc_mote]);
  memset((void *)&preambleTestC$t1[__nesc_mote], 0, sizeof preambleTestC$t1[__nesc_mote]);
  memset((void *)&preambleTestC$t2[__nesc_mote], 0, sizeof preambleTestC$t2[__nesc_mote]);
  memset((void *)&preambleTestC$t3[__nesc_mote], 0, sizeof preambleTestC$t3[__nesc_mote]);
  memset((void *)&preambleTestC$isupdate[__nesc_mote], 0, sizeof preambleTestC$isupdate[__nesc_mote]);
  memset((void *)&preambleTestC$exp[__nesc_mote], 0, sizeof preambleTestC$exp[__nesc_mote]);
  memset((void *)&preambleTestC$countpre[__nesc_mote], 0, sizeof preambleTestC$countpre[__nesc_mote]);
  memset((void *)&preambleTestC$flag1[__nesc_mote], 0, sizeof preambleTestC$flag1[__nesc_mote]);
  ...
  /* Module QueueC$0 */
  memset((void *)&/*preambleTestAppC.SendQueueP*/QueueC$0$queue[__nesc_mote], 0, sizeof /*preambleTestAppC.SendQueueP*/QueueC$0$queue[__nesc_mote]);
  /*preambleTestAppC.SendQueueP*/QueueC$0$head[__nesc_mote] = 0;
  /*preambleTestAppC.SendQueueP*/QueueC$0$tail[__nesc_mote] = 0;
  /*preambleTestAppC.SendQueueP*/QueueC$0$size[__nesc_mote] = 0;
